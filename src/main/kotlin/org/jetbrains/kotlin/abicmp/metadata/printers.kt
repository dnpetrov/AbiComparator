...
private fun visitProperty(
        sb: StringBuilder, flags: Flags, name: String, getterFlags: Flags, setterFlags: Flags
): KmPropertyVisitor =
    ...
    override fun visitExtensions(type: KmExtensionType): KmClassExtensionVisitor? {
        ...
        return object : JvmClassExtensionVisitor() {
            ...
            override fun visitLocalDelegatedProperty(
                    ...
                    visitProperty(
                            StringBuilder().also { localDelegatedProperties.add(it) },
                            flags, name, getterFlags, setterFlags
                    )
            ...
            override fun visitEnd() {
                sb.appendDeclarationContainerExtensions(localDelegatedProperties, moduleName)
            }
        }
    }
...
//            ClassPrinter().also(optionalAnnotations::add)
